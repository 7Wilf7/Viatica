...
import { normalizeTransaction, summarizeLedger } from "./ledger.js";
...
test("cloud demo seed data is valid and useful for chart review", () => {
  ...
  const summary = summarizeLedger(transactions, DEMO_BUDGETS, now);
  ...
  assert.ok(summary.accountNet.ledger > 0);
});
